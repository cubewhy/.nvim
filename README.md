...
```sh
git clone https://github.com/cubewhy/.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/cubewhy/.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/cubewhy/.nvim.git "${env:LOCALAPPDATA}\nvim"
```
